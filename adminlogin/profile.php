                ...
                <div class="x_panel"  style="background-color: #FFFFFF; " > 
                   ...
                   <?php if(empty($_GET["page"])){ ?> 
					...
					?>
               		...
               		<form role="form" name="frmMain" method="post" action="save_profile_update2.php" enctype="multipart/form-data" >
					...
					<div class="form-group"> <br> 
					<font color="black" size="3px" class="serif"> username  </font> 
					<input type="text" name="username" id="username" class="form-control " value="<?php echo $username; ?>" autocomplete="off"  style=" border-radius: 10px; margin-top: 10px; " readonly required      > 
					</div>
					</div> 
					<div class="col-lg-6 ">
					<div class="form-group"> <br> 
