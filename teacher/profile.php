...
<div id="wrapper" class="container">
  <h1 id="page-title"> ข้อมูล อาจารย์  </h1>
  <div class="row">
    ...
    <div class="col-md-12"> 
	  ...
	  <input type="hidden" name="idupdate" id="idupdate" class="form-control " value="<?php echo $_SESSION["UserID3"]; ?>" >
     	  ...
     	  <div class="row">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    <label for="name"> ชื่อ - นามสกุล :</label> <!--- เก็บชื่อผู้ใช้งาน   --->
                    <input type="text" class="form-control" id="name" name="name" required="" value="<?php echo $name; ?>" style="border-radius: 5px;" >
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group">
                    <label for="name"> ชื่อ - นามสกุล ( English ) :</label> <!--- เก็บชื่อผู้ใช้งาน   --->
                    <input type="text" class="form-control" id="name2" name="name2" required="" value="<?php echo $name2; ?>" style="border-radius: 5px;" >
                </div>
            </div>
            ...
            <div class="col-md-6">
                <div class="form-group">
                    <label for="address"> สถานที่ติดต่อ : </label> <!--- เก็บที่อยู่--->
            ...
            <div class="col-md-6" style="display: none; ">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="major" name="major"   value="<?php echo $major; ?>"  style="border-radius: 5px;"  >
                </div>
            </div> 
            <div class="col-md-6">
                <div class="form-group">
