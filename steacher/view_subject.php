												...
												<div class="col-lg-10">
													<div class="form-group"> <br>
														...
														<table width="100%" border="1">
															...
															-- LEFT JOIN grade in grade.grade_id = classdata_section.grade
																...
																<tr>
																	<div class="col-lg-4 ">
																		<div class="form-group"> <br>
																			...
																			<input disabled type="text" name="grade" id="data14" class="form-control " value="<?php echo $grade_name; ?>" autocomplete="off" style=" border-radius: 10px; margin-top: 10px; ">
																	...
																	<div class="col-lg-4 ">
																		<div class="form-group"> <br>
																			...
																			<select class="form-control" id="grade_id" name="grade_id" style=" border-radius: 10px; margin-top: 10px; " required>
