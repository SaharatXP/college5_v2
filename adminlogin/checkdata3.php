                    ...
                    <form role="form" name="frmMain" method="get" action="checkdata3.php" enctype="multipart/form-data" >  
						<div class="row">  
							...
							<font color="black" size="3px" class="serif">  &nbsp;&nbsp; <br>  </font> 
								 ...
								 <button type="button" class="btn btn-primary" style="background-color: #0000FF; border-radius: 10px; width: 140px; border-color: white; "> <font color="white" size="3px" class="serif" >   ผู้ช่วยอาจารย์ </font> </button>
								 </a>
					...
					<tr>
					  ...
					  <tbody>
						...
						<td><div align="center"><font size="2px" color="Black">  
				    		<a href="view_student.php?CusID=<?php echo $objResult["pk"];?>&page=" ><font class="btn btn-sm btn-primary" size="2px" color="#000"> คลิก   </font></a> 
				    	</font></div></td>   
