                        ...
                        <div class="col-lg-12 ">
                            ...
                            <div class="form-group " id="printableArea"> -->
                                            ...
                                            ?>
                                                ...
                                                where pk = $_SESSION[UserID3]";
                                                    ...
                                                    while ($objResultU = mysqli_fetch_array($queryu)) {
                                                        ...
                                                        <b> ชื่อ-สกุล </b>: <?php echo $objResultU['name']; ?> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <b>รหัสประจำตัว : </b> <?php echo $objResult['codestudent'] ?><br>
                                                    <?php }
                                                    ?>
                                    ...
                                    <div class="col-lg-12" align="left" style="margin-top: 15px; ">
                                        ...
                                        ?>
                                            <h4><?php echo  'เดือน : ' . DateThai3($objResultM['savedata1']) ?> <?php echo $y ?> </h4>
                                            <?php
                                                            ...
                                                            order by a.pk asc ";
                                                                ...
                                                                ?>
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <?php echo $objResultDt['savedata7'] ?> <br>
