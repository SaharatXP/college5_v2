                        ...
                        <tr>
                            <td width="35%">
                                ...
                                <input type="text" name="searchname" id="searchname" class="form-control "
                                    value="<?php echo $searchname; ?>" autocomplete="off" autofocus
                                    style="  border-radius: 0px; width: 95%;   ">
                            </td>
                            <td width="35%">
                                <font color="black" size="3px" class="serif"> ภาคการศึกษา </font>
                                <select class="form-control" id="drop_term" name="drop_term" required
                                    style="border-radius: 0px;  width: 95%; ">
                ...
                <div class="subject-item" style="border-radius: 10px;">
                    ...
                    <div class="row" style="margin-top: 10px; margin-bottom: 5px;">
                        <?php
							...
							?>
                        <b style="color:red;">วิชานี้ปิดรับสมัครแล้ว</b><br>

                        <a class="btn btn-primary btn-minwidth" style="width: 100%;  margin-top: 10px; " disabled> สมัคร
                            <br>
                        </a>
                        <?php
                        ...
                        <div class="col-lg-12">
                            <a href="view_subject3.php?CusID=<?php echo $objResult["pk"]; ?>"
                                class="btn btn-primary btn-minwidth" style="width: 100%;  margin-top: 10px; "> สมัคร
                                <br>
                                (ปริญญาตรี) </a>
                        </div>
                        <?php } ?>
                        ...
                        <div class="col-lg-12">
                            <a href="view_subject.php?CusID=<?php echo $objResult["pk"]; ?>"
                                class="btn btn-primary btn-minwidth" style="width: 100%;  margin-top: 10px; "> สมัคร
                                <Br>
                                (ปริญญาโท-เอก) </a>
                        </div>
