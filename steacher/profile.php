...
<div id="wrapper" class="container">
  <h1 id="page-title"> ข้อมูล ผู้ช่วยอาจารย์  </h1>
  <div class="row">
  ...
  <div class="row">
    <div class="col-md-12"> 
      <div class="announce-item">  
        ...
        <?php 
		  //// โหลดข้อมูล ส่วนตัวของผู้ใช่งานนั้น ๆ
			$sql = "SELECT * FROM member Where  pk = '". $_SESSION["UserID3"] ."' ";  
	  ...
	  <input type="hidden" name="idupdate" id="idupdate" class="form-control " value="<?php echo $_SESSION["UserID3"]; ?>" >
     	  ...
     	  <div class="row">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    <label for="phone"> เช็ครหัสผ่าน : </label> 
            ...
            <div class="col-md-6">
                <div class="form-group">
                    <label for="address"> อัพโหลดสำเนาบัตรประชาขชน  : </label> <!--- เก็บที่อยู่--->
					<input type="file"  name="img2"  class="form-control"   style="border-radius: 5px;" />  
                </div>
            </div> 
            ...
            <div class="col-md-6">
                <div class="form-group">
                    <label for="address"> อัพโหลดสำเนาทะเบียนบ้าน  : </label> <!--- เก็บที่อยู่--->
					<input type="file"  name="img3"  class="form-control"  style="border-radius: 5px;"  />  
                </div>
            </div> 
            ...
            <div class="col-md-6">
                <div class="form-group">
                    <label for="address"> อัพโหลดสมุดบัญชีธนาคาร  : </label> <!--- เก็บที่อยู่--->
					<input type="file"  name="img4"  class="form-control"   style="border-radius: 5px;" />  
                </div>
            </div> 
